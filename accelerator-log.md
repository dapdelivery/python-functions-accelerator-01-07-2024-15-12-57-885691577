...
```json
{
  ...
  "projectName" : "python-functions-accelerator-01-07-2024-15-12-57-885691577",
  "repositoryPrefix" : "gcr.io/tap-ci/ci-pipeline/apps-01-07-2024-15-12-57-885691577"
}
```
## Log
```
...
┃ ┃ ┃ ┃ ┗ ┗  Info Will replace [python-function->python-functions-acc...(truncated), main->main]
