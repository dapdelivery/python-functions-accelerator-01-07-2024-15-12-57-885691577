...
```
pack build python-functions-accelerator-01-07-2024-15-12-57-885691577 --path . --builder ghcr.io/vmware-tanzu/function-buildpacks-for-knative/functions-builder:0.3.1 --env BP_FUNCTION=func.main
```

Where `python-functions-accelerator-01-07-2024-15-12-57-885691577` is the name of your runnable function image.

Then run via Docker:

```
docker run -it --rm -p 8080:8080 python-functions-accelerator-01-07-2024-15-12-57-885691577
```
...
```
tanzu apps workload create python-functions-accelerator-01-07-2024-15-12-57-885691577 -f config/workload.yaml \
  --local-path . \
  --type web
```
...
```
tanzu apps workload get python-functions-accelerator-01-07-2024-15-12-57-885691577
```
